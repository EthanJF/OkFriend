    ...
    render(){
        return(
            <div className="welcome">
                ...
                {this.state.returningUser ? (<Login setToken={this.props.setToken} showMainDiv={this.props.showMainDiv} />) : (<Signup setToken={this.props.setToken} showMainDiv={this.props.showMainDiv}/>)}
            </div>
        )
    }
}